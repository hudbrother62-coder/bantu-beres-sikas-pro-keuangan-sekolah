...
// - A fresh account created from an invite becomes staff, not principal.
// - The invite is accepted before the app reloads the user's membership.
// - A principal who is already logged in is not silently converted/overwritten.
